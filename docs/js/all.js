...
(function () {
  ...
  var menuToggle = document.querySelector(".nav__button");
  var nav = document.querySelector(".nav__wrapper");
  menuToggle.classList.remove("nav__button--no-js"), nav.classList.add("nav--hide"), menuToggle.addEventListener("click", function (e) {
    e.preventDefault(), menuToggle.classList.toggle("nav__button--closed"), menuToggle.classList.toggle("nav__button--opened"), nav.classList.toggle("nav--hide");
  });
})();
"use strict";
...
(function () {
  ...
  var SHOW_POPUP_CLASSNAME = 'popup--show';
  ...
  popupWindow.addEventListener('click', function () {
    return popupWindow.classList.remove(SHOW_POPUP_CLASSNAME);
  });
...
(function () {
  ...
  var scrollButton = document.querySelector(".link-section__button");
  var scrollStop = document.querySelector(".activity");
  scrollButton.addEventListener("click", function (e) {
    e.preventDefault(), scrollStop.scrollIntoView(top);
  });
})();
"use strict";
...
(function () {
  ...
  var ACTIVE_BUTTON_CLASSNAME = 'slider__btn--active';
  var HORIZONTAL_PADDING = 28;
  var DESKTOP_WIDTH = 988;
  var slideWidth;
  ...
  var changeActiveClassname = function changeActiveClassname(index) {
    var _iterator = _createForOfIteratorHelper(sliderBtns),
        _step;
  ...
  slideList.addEventListener('touchend', function (e) {
    ...
    var shift = positionEnd - positionStart;
    ...
    slideList.style.transform = "translateX(-".concat(slideWidth * activeIndex, "px)");
  });
  ...
  var _loop = function _loop(i) {
    sliderBtns[i].addEventListener('click', function () {
      ...
      slideList.style.transform = "translateX(-".concat(slideWidth * i, "px)");
    });
  };
